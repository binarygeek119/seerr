...
## Installation
```console
helm install seerr oci://ghcr.io/binarygeek119/seerr/seerr-chart
```
Helm values can be found in the Seerr repository under [charts/seerr-chart/README.md](https://github.com/binarygeek119/seerr/tree/develop/charts/seerr-chart).
...
```console
cosign verify ghcr.io/binarygeek119/seerr/seerr-chart:[tag] --certificate-identity=https://github.com/binarygeek119/seerr/.github/workflows/helm.yml@refs/heads/main --certificate-oidc-issuer=https://token.actions.githubusercontent.com
```
