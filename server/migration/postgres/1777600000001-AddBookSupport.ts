...
export class AddBookSupport1777600000001 implements MigrationInterface {
  name = 'AddBookSupport1777600000001';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "media" ADD "foreignBookId" character varying`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_8f2c1a9e7d3b4c5a6e9f0d1b2c"`
    );
    await queryRunner.query(
